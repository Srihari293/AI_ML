...
class ParticleFilter:
    ...
    def predict(self, control):
        ...
        left_variance = (self.control_motion_factor * left)**2 + (self.control_turn_factor*(right-left))**2
        right_variance = (self.control_motion_factor * right)**2 + (self.control_turn_factor*(right-left))**2
...
if __name__ == '__main__':
    ...
    # Read data.
    logfile = LegoLogfile()
    logfile.read(r"C:\Users\sriha\OneDrive\Documents\Code\AI_ML\Courses\SLAM_and_path_planning\Unit-E\robot4_motors.txt")

    # Loop over all motor tick records.
    # This is the particle filter loop, with prediction and correction.
    f = open("Unit-E/particle_filter_predicted.txt", "w")
