...
# For each area between a left falling edge and a right rising edge, determine the average ray number and the average depth.
def find_cylinders(scan, scan_derivative, jump, min_dist):
    ...
    for i in range(len(scan_derivative)):
        ...
        # Whenever a cylinder is found, add a tuple(average_ray, average_depth) to the cylinder_list.
